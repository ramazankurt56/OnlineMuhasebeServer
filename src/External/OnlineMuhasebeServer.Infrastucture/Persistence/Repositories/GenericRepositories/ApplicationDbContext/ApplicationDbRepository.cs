...
namespace OnlineMuhasebeServer.Infrastucture.Persistence.Repositories.GenericRepositories.ApplicationDbContext;
public class ApplicationDbRepository<T> : IApplicationDbRepository<T>
    where T : class
{
    private readonly Context.ApplicationDbContext _context;

    public ApplicationDbRepository(Context.ApplicationDbContext context)
    {
        _context = context;
